...
const schema = {
    ...
    required: ["anio_nacimiento","color_ojos","peliculas","genero","color_cabello","talla","planeta","masa","nombre","color_piel","especies","naves","id","vehiculos"]
  }


module.exports.index = async (event) => {
    const query = (typeof event.queryStringParameters != 'undefined')? event.queryStringParameters:{};
    const search = (query && typeof query.search != 'undefined')?query.search:'';
...
module.exports.submit = async (event) => {
    ...
    await dynamoDb.put(peopleInfo).promise().then(res => {});
    return {
        statusCode: 200,
